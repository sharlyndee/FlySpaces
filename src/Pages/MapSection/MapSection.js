    ...
    <div className='container-fluid'>
        <div className='row mt-5 ml-5'>
                <div className='col-sm-5'>
                    ...
                    <p className='text graytext'>Sebagai kota terbesar di Asia Tenggara, Jakarta muncul dalam beberapa
                    ...
                    <div className='col-sm-7 sizediv'>
                        ...
                        <div className='col-sm-5 over'>
                            ...
                            <p className='text graytext'> Kota, ekosistem startup, dan perekonomian di Jakarta sedang berubah cepat, 
                            ...
                            regional, dan Jakarta telah melihat masuknya perusahaan besar seperti 
