...
import CommonButton from '../Component/button.js'
        ...
        <div className='row mt-2'>
            <div className='col-sm-2 ml-5 mt-2'>
              ...
              <div className='col-sm-2 mt-3'>
                <CommonButton className='btn-sm p-2'><img src='https://img.icons8.com/carbon-copy/2x/phone.png' alt='' className
                ='phone'></img>HUBUNGGI SEKARANG</CommonButton>
              </div>
          </div> 
        </div>
    <div className='container-fluid'>
        ...
        <div className='container mt-5 justify-content-center'>
          ...
          <p className='h3 p-2 textcolor'>FlySpace memiliki beratus-ratus pilihan ruang kerja fleksibel untuk anda 
            pilih di Jakarta-jelajahi pilihanmu di platform #1 Asia Tenggara</p>
            <div className='center'>
          <CommonButton className='button p-3'>JELAJAHI SEMUA TEMPAT DI JAKARTA</CommonButton>
          </div>
        </div>
        </div> 
        </div>
